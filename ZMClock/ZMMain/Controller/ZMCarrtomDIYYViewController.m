...
//test
//#define SKINColor RGB(231, 222, 220)
//#define SKINColor RGB(251, 228, 207)



//#define SKINColor RGB(240, 191, 158)
//#define SKINColor RGB(251, 228, 207)

#define SKINColor RGB(242, 208, 180)

@interface ZMCarrtomDIYYViewController ()<UITableViewDelegate,UITableViewDataSource,UIImagePickerControllerDelegate,UINavigationControllerDelegate, UIGestureRecognizerDelegate>
{
...
//    GPUImageFilter *_stillImageFilter;//头像处理
//    GPUImageFilter *_stillImageFilter22;//头像处理
    
    BOOL _secondXX;//第二套形象
    
    
    BOOL _poped;//从第二个页面 返回
...
@implementation ZMCarrtomDIYYViewController



+ (ZMCarrtomDIYYViewController *)sharedZMCarrtomDIYYViewController
{
    static ZMCarrtomDIYYViewController *defautVC = nil;
...
//    
    ...
    fileterModel = [[ZMHeaderPoartColorSetModel alloc] init];
    fileterModel.classname = @"GPUImageAverageLuminanceThresholdFilter";
    fileterModel.selector = @"setThresholdMultiplier:";
    fileterModel.showname = @"黑白";//4
    fileterModel.maxValue = 1;
    fileterModel.minValue = 0;
    [_filetersArray addObject:fileterModel];
...
//    
    ...
    fileterModel = [[ZMHeaderPoartColorSetModel alloc] init];
    fileterModel.classname = @"GPUImageSketchFilter";
    fileterModel.selector = @"setEdgeStrength:";
    fileterModel.showname = @"黑白素描" ;//6
    fileterModel.maxValue = 1;
    fileterModel.minValue = 0;
    [_filetersArray addObject:fileterModel];
...
//
//    ZMCartoonDIYYModel *diyModel3 = [[ZMCartoonDIYYModel alloc] init];
//    diyModel3.xxImgName = @"疯狂动物城-女头发";
//    [self.xxMuArray addObject:diyModel3];
//    
//    ZMCartoonDIYYModel *diyModel4 = [[ZMCartoonDIYYModel alloc] init];
//    diyModel4.xxImgName = @"疯狂动物城-男头发";
//    [self.xxMuArray addObject:diyModel4];
//    
//    ZMCartoonDIYYModel *diyModel5 = [[ZMCartoonDIYYModel alloc] init];
//    diyModel5.xxImgName = @"疯狂动物城-女头发";
//    [self.xxMuArray addObject:diyModel5];
//    
//    ZMCartoonDIYYModel *diyModel6 = [[ZMCartoonDIYYModel alloc] init];
//    diyModel6.xxImgName = @"疯狂动物城-男头发";
//    [self.xxMuArray addObject:diyModel6];
//    
//    ZMCartoonDIYYModel *diyModel7 = [[ZMCartoonDIYYModel alloc] init];
//    diyModel7.xxImgName = @"疯狂动物城-女头发";
//    [self.xxMuArray addObject:diyModel7];
//    
//    ZMCartoonDIYYModel *diyModel8 = [[ZMCartoonDIYYModel alloc] init];
//    diyModel8.xxImgName = @"疯狂动物城-男头发";
//    [self.xxMuArray addObject:diyModel8];
//    
//    ZMCartoonDIYYModel *diyModel9 = [[ZMCartoonDIYYModel alloc] init];
//    diyModel9.xxImgName = @"疯狂动物城-女头发";
//    [self.xxMuArray addObject:diyModel9];
//    
...
//
//    ZMCartoonDIYYModel2 *diyModel33 = [[ZMCartoonDIYYModel2 alloc] init];
//    diyModel33.girl_xxImgName = @"疯狂动物城-女头发";
//    [self.girl_xxMuArray addObject:diyModel33];
//    
//    ZMCartoonDIYYModel2 *diyModel44 = [[ZMCartoonDIYYModel2 alloc] init];
//    diyModel44.girl_xxImgName = @"疯狂动物城-男头发";
//    [self.girl_xxMuArray addObject:diyModel44];
//    
//    ZMCartoonDIYYModel2 *diyModel55 = [[ZMCartoonDIYYModel2 alloc] init];
//    diyModel55.girl_xxImgName = @"疯狂动物城-女头发";
//    [self.girl_xxMuArray addObject:diyModel55];
//    
...
//    maskLayer.frame = CGRectMake(100, 200, 100, 100);
//    
//    UIImage *maskimge = IMAGE(@"男脸线稿大-1bxiu");
...
//    self.bgImgV.backgroundColor = SKINColor;
//    
...
//    self.bgImgV.layer.mask = maskLayer;
    ...
    //UIImage * immm = [self maskImage:self.bgImgV.image withMask:IMAGE(@"未命名_meitu_1rrrrrrrrrrr")];
    
    
    
    //UIImage *small = [UIImage imageWithCGImage:immm.CGImage scale:0.25 orientation:immm.imageOrientation];

    
    
    
    //self.bgImgV.image = immm;
    

    //[self addGestureRecognizerToView:self.imggf];
...
#pragma mark -----------------------------------脸部 DIY 按钮
    ///脸部 DIY 按钮
    if ([ZMSystemTool iPhone5Device]) {
        
        self.faceDiyImgV = [[UIImageView alloc] initWithFrame:CGRectMake(10, 80, 50 , 50 )];
...
///通知
    [[NSNotificationCenter defaultCenter] addObserver:self selector:@selector(changeBoyyMaskkbgg22tV) name:@"changeMaskImgbg22t" object:nil];
    
    [[NSNotificationCenter defaultCenter] addObserver:self selector:@selector(changeBoyyMaskkbgg11tV) name:@"changeMaskImgbg11t" object:nil];
...
- (void)changeBoyyMaskkbgg22tV
{
    ...
    [self.maskkBgImgVv removeFromSuperview];
    [self.maskkBgImgVv2 removeFromSuperview];
    
    self.roleImgV.hidden = YES;
...
- (void)changeBoyyMaskkbgg11tV
{
    ...
    self.sec_boy_roleHeadHairImgV.hidden = YES;//头发
    self.sec_girl_roleHairImgV.hidden = YES;
    
    self.sec_boy_glassImgV.hidden = YES;//眼镜
    self.sec_girl_glassImgV.hidden = YES;
...
//    if ([ZMSystemTool iPhone5Device]) {
//        
//        self.xxBtn = [[UIButton alloc] initWithFrame:CGRectMake(0, kScreen_Height - 50, kScreen_Width/3 - 1.3, 50)];
//        
//    } else {
//        
...
//    if ([ZMSystemTool iPhone5Device]) {
//        
//        self.glassBtn = [[UIButton alloc] initWithFrame:CGRectMake(kScreen_Width/3 + 1, kScreen_Height - 50, kScreen_Width/3 - 0, 50)];
//        
//    }else {
//    
//    
...
//    [self.view addSubview:self.faceBtn];
    ...
    //底部 tableview 背景
//    self.tablebgV = [[UIView alloc] initWithFrame:CGRectMake(0, kScreen_Height - 100 , kScreen_Width, 100 )];
...
#pragma mark -------------------------------------卡通身体
    ...
    if ([ZMSystemTool iPhone5Device]) {
        ...
        self.roleImgV = [[UIImageView alloc] initWithFrame:CGRectMake(0, 0, kScreen_Width , kScreen_Height - 0)];
    ...
    self.roleImgV.image = IMAGE(@"动物城-角色-3.5头身");
    ...
    if ([ZMSystemTool iPhone5Device]) {
        ...
        self.maskLayerbgg.frame = CGRectMake(0, 0, 120, 140);
    }
    
    self.maskImgebg = IMAGE(@"鹿晗脸b");
        
    
    self.maskLayerbgg.contents = (__bridge id)self.maskImgebg.CGImage;//根据图片形状裁剪图片
    

#pragma mark ------------------------------------调整 1 头像 mask
    //
    if ([ZMSystemTool iPhone5Device]) {
        
        self.maskkBgImgVv = [[UIImageView alloc] initWithFrame:CGRectMake(100 - 34, 122,  115, 130)];
        
    }else if ([ZMSystemTool iPhone6Device]) {
        
        self.maskkBgImgVv = [[UIImageView alloc] initWithFrame:CGRectMake(100 - 10, 187 - 18,  115, 130)];
        
    } else {
        self.maskkBgImgVv = [[UIImageView alloc] initWithFrame:CGRectMake(100, 187,  120, 140)];
    }
...
///识别头像背景 1
    ...
    if ([ZMSystemTool iPhone5Device]) {
        ...
        self.roleBgImgV = [[UIImageView alloc] initWithFrame:CGRectMake(-5, 10,  125, 135)];
        
    }else if ([ZMSystemTool iPhone6Device]) {
        
        self.roleBgImgV = [[UIImageView alloc] initWithFrame:CGRectMake(-13, 5,  143, 140)];
        
    } else {
        
        self.roleBgImgV = [[UIImageView alloc] initWithFrame:CGRectMake(-15, 10,  130, 140)];
    }
    
    //self.roleBgImgV = [[UIImageView alloc] initWithFrame:CGRectMake(-50 + 13, -50 + 15,  100, 120)];
    ...
    //[self.bgImgV addSubview:self.roleBgImgV];//
    [self.maskkBgImgVv addSubview:self.roleBgImgV];
    
    
    
#pragma mark --------------------------------人脸识别的图片 男
    
    if ([ZMSystemTool iPhone5Device]) {
        
        self.roleHeadImgV = [[UIImageView alloc] initWithFrame:CGRectMake(28, 30, 75, 75)];
        
        
    } else if ([ZMSystemTool iPhone6Device]) {
        
        self.roleHeadImgV = [[UIImageView alloc] initWithFrame:CGRectMake(36, 35, 70, 80)];
        
    } else {
    
    
        self.roleHeadImgV = [[UIImageView alloc] initWithFrame:CGRectMake(34, 30, 80, 90)];
    }
...
#pragma mark -------------------------------------男-盖脸遮罩
    ...
    if ([ZMSystemTool iPhone5Device]) {
        ...
        UIImageView *rolll = [[UIImageView alloc] initWithFrame:CGRectMake(5, 10,  135, 130)];
        ...
        UIImageView *rolll = [[UIImageView alloc] initWithFrame:CGRectMake(- 3, 10,  155, 135)];
...
//    rolll.image = IMAGE(@"game_view_head_bggf");//遮罩  game_view_head_bg2zhong//game_view_head_bggf
//
//    rolll.userInteractionEnabled = YES;
//    
//    [self.roleBgImgV addSubview:rolll];
...
//字符串转图片
    ...
    if (faceStr == nil || faceStr == NULL || [faceStr isKindOfClass:[NSNull class]]) {
        ...
        //结束绘画
        self.headCortImg = UIGraphicsGetImageFromCurrentImageContext();
...
//////
    ...
    if ([ZMSystemTool iPhone5Device]) {
        ...
        self.maskLayerbgg2.frame = CGRectMake(0, 0, 95, 110);
    ...
    self.maskImgebg2 = IMAGE(@"女脸线稿大-1b");//头像背景剪切模板     男脸线稿大-1bxiu
    
    self.maskLayerbgg2.contents = (__bridge id)self.maskImgebg2.CGImage;//根据图片形状裁剪图片
    

#pragma mark ------------------------------------调整 2 头像 mask
    
    if ([ZMSystemTool iPhone5Device]) {
        
        self.maskkBgImgVv2 = [[UIImageView alloc] initWithFrame:CGRectMake(100 - 34 + 93, 122 + 92 + 2,  95, 110)];
        
    }else if ([ZMSystemTool iPhone6Device]) {
        
        self.maskkBgImgVv2 = [[UIImageView alloc] initWithFrame:CGRectMake(205 - 20, 287 - 29,  105, 121)];
        
    } else {
        
        self.maskkBgImgVv2 = [[UIImageView alloc] initWithFrame:CGRectMake(205, 287,  115, 131)];
    }
...
///头像 2
    if ([ZMSystemTool iPhone5Device]) {
        ...
        self.roleBgImgV2 = [[UIImageView alloc] initWithFrame:CGRectMake(- 6, 15,  110, 100)];
        
    } else if ([ZMSystemTool iPhone6Device]) {
        
        self.roleBgImgV2 = [[UIImageView alloc] initWithFrame:CGRectMake(- 5 + 1, 23,  117, 105)];
        ...
        self.roleBgImgV2 = [[UIImageView alloc] initWithFrame:CGRectMake(- 3, 20,  120, 110)];
        
    }
    //self.roleBgImgV2 = [[UIImageView alloc] initWithFrame:CGRectMake(10, 20,  100, 120)];
    
    self.roleBgImgV2.backgroundColor = SKINColor;
    //self.roleBgImgV2.backgroundColor = [UIColor orangeColor];
    self.roleBgImgV2.image = IMAGE(@"game_view_head_bg22");
    
    self.roleBgImgV2.userInteractionEnabled = YES;
    
    [self.maskkBgImgVv2 addSubview:self.roleBgImgV2];///666
    
    
#pragma mark ------------------------------人脸识别图片--女
    //人脸识别的图片 2
    if ([ZMSystemTool iPhone5Device]) {
        
        self.roleHeadImgV2 = [[UIImageView alloc] initWithFrame:CGRectMake(26, 20, 58, 63)];
        
    } else if ([ZMSystemTool iPhone6Device]) {
        
       //self.roleHeadImgV2 = [[UIImageView alloc] initWithFrame:CGRectMake(20, 25, 70, 70)];
        ...
        self.roleHeadImgV2 = [[UIImageView alloc] initWithFrame:CGRectMake(25, 25, 70, 73)];
    ...
    [self.roleBgImgV2 addSubview:self.roleHeadImgV2];//
...
#pragma mark -------------------------------------女--盖脸遮罩
    //UIImageView *rolll22 = [[UIImageView alloc] initWithFrame:CGRectMake(- 28, -50,  148 , 180)];
    
    if ([ZMSystemTool iPhone5Device]) {
        
        UIImageView *rolll22 = [[UIImageView alloc] initWithFrame:CGRectMake(- 11, -5,  125 , 110)];
        rolll22.image = IMAGE(@"diyyzhezaoo");//遮罩  game_view_head_bg2zhong//game_view_head_bggf
        ...
        UIImageView *rolll22 = [[UIImageView alloc] initWithFrame:CGRectMake(0, 5,  130 - 8,  115)];
        rolll22.image = IMAGE(@"diyyzhezaoo");//遮罩  game_view_head_bg2zhong//game_view_head_bggf//game_view_head_bggf
    ...
    if (faceStr2 == nil || faceStr2 == NULL || [faceStr2 isKindOfClass:[NSNull class]]) {
        ...
        ///裁剪图片
        CGFloat width = faceImg2.size.width;
        CGFloat hight = faceImg2.size.height;
        
        //NSLog(@"wwwwwwwww%f       hhhhhhhhhh%f",width,hight);
        //开始绘制图片
        UIGraphicsBeginImageContext(faceImg2.size);
        CGContextRef ref = UIGraphicsGetCurrentContext();
        ...
        CGContextTranslateCTM(ref, 0, hight);
        CGContextScaleCTM(ref, 1, -1);
        CGContextDrawImage(ref, CGRectMake(0, 0, width, hight), [faceImg2 CGImage]);
        
        //结束绘画
        self.headCortImg2 = UIGraphicsGetImageFromCurrentImageContext();
        UIGraphicsEndImageContext();
        
        
        
        // 磨皮算法处理的图片
        //UIImage *faceGrindingImg2 = [FaceGrindingImage imageByBilateralFilterImage:self.headCortImg2 distance:10.0];
//        UIImage *transParentImg2 = [self imageToTransparent:faceGrindingImg2];
//        
//        UIImage *lasttImg12 = [self imageBlackToTransparent:transParentImg2];
        
        
        //UIImage *transParentImg2 = [ZRRImageTool imageToTransparent222:faceGrindingImg2];
        
        //UIImage *lasttImg12 = [ZRRImageTool imageBlackToTransparent222:transParentImg2];
...
//        
//        //UIImage *testtt = [ImageUtil imageWithImage:outImgr withColorMatrix:colormatrix_testt];
//        self.girl_testtt = [ImageUtil imageWithImage:outImgr withColorMatrix:colormatrix_testt];
...
//头像遮罩 2     //70 90
    self.roleHeadCoverImgV3 = [[UIImageView alloc] initWithFrame:CGRectMake(-5 , 4, 83, 90)];
    
    self.roleHeadCoverImgV3.backgroundColor = [UIColor clearColor];
    self.roleHeadCoverImgV3.image = IMAGE(@"遮罩200乘200");
    
   // [self.roleBgImgV2 addSubview:self.roleHeadCoverImgV3];
...
//头像遮罩 1  2
    ...
    if ([ZMSystemTool iPhone5Device]) {
        ...
        //self.roleHeadCoverImgV2 = [[UIImageView alloc] initWithFrame:CGRectMake(90, 187, 120, 140)];
        
        self.roleHeadCoverImgV2 = [[UIImageView alloc] initWithFrame:CGRectMake(0, 0, 120, 140)];
        
    }
    
    self.roleHeadCoverImgV2.image = IMAGE(@"鹿晗脸");
    
    self.roleHeadCoverImgV2.backgroundColor = [UIColor clearColor];
    [self.maskkBgImgVv addSubview:self.roleHeadCoverImgV2];
        

        //[self.roleImgV addSubview:self.roleHeadCoverImgV2];
...
//头像遮罩 2  2
    ...
    if ([ZMSystemTool iPhone5Device]) {
        ...
        self.roleHeadCoverImgV4 = [[UIImageView alloc] initWithFrame:CGRectMake(0, 0,  95, 110)];
        ...
        self.roleHeadCoverImgV4 = [[UIImageView alloc] initWithFrame:CGRectMake(0, 0, 115, 131)];
    }
    //self.roleHeadCoverImgV4 = [[UIImageView alloc] initWithFrame:CGRectMake(195, 287, 115, 131)];
    
    self.roleHeadCoverImgV4.backgroundColor = [UIColor clearColor];
    self.roleHeadCoverImgV4.image = IMAGE(@"女-脸animal");
    
    [self.maskkBgImgVv2 addSubview:self.roleHeadCoverImgV4];
        
    
    //[self.roleImgV addSubview:self.roleHeadCoverImgV4];
...
//头发 1
    ...
    if ([ZMSystemTool iPhone5Device]) {
        ...
        self.roleHeadHairImgV = [[UIImageView alloc] initWithFrame:CGRectMake(34 - 17, 72, 210, 160)];
        
    }else if ([ZMSystemTool iPhone6Device]) {
        
        self.roleHeadHairImgV = [[UIImageView alloc] initWithFrame:CGRectMake(34 + 12, 128 - 7, 209 - 14, 165 - 10)];
        
        
    } else {
        
        self.roleHeadHairImgV = [[UIImageView alloc] initWithFrame:CGRectMake(49, 133, 210, 172)];
    }
    
    self.roleHeadHairImgV.backgroundColor = [UIColor clearColor];
   
    
    self.roleHeadHairImgV.image = IMAGE(@"动物城-男头发耳朵2");
    
    [self.view addSubview:self.roleHeadHairImgV];
    
    
    //[self.roleImgV addSubview:self.roleHeadHairImgV];
...
//头发 2
        ...
        if ([ZMSystemTool iPhone5Device]) {
            ...
            self.roleHeadHairImgV2 = [[UIImageView alloc] initWithFrame:CGRectMake(185 - 35, 80, 130, 280)];
            
        }else if ([ZMSystemTool iPhone6Device]) {
            
            self.roleHeadHairImgV2 = [[UIImageView alloc] initWithFrame:CGRectMake(180 , 150 - 24, 150 - 13, 300 - 14)];
            
        } else {
            
            self.roleHeadHairImgV2 = [[UIImageView alloc] initWithFrame:CGRectMake(195, 150, 155, 290)];
        }
        //self.roleHeadHairImgV2 = [[UIImageView alloc] initWithFrame:CGRectMake(185, 150, 150, 300)];
        
        self.roleHeadHairImgV2.backgroundColor = [UIColor clearColor];
        self.roleHeadHairImgV2.image = IMAGE(@"动物城-女头发耳朵2");
        
        [self.view addSubview:self.roleHeadHairImgV2];

    
    
    
    //[self.roleImgV addSubview:self.roleHeadHairImgV2];///666
...
#pragma mark ----------------------------------用户没有设置头像
    ...
    if ([ZMSystemTool iPhone5Device]) {
        ...
        self.nodiy_boyImgV = [[UIImageView alloc] initWithFrame:CGRectMake(83, 153, 80, 100)];
        
    }else if ([ZMSystemTool iPhone6Device]) {
        
        self.nodiy_boyImgV = [[UIImageView alloc] initWithFrame:CGRectMake(105, 200, 85, 100)];
        
    } else {
        
        self.nodiy_boyImgV = [[UIImageView alloc] initWithFrame:CGRectMake(113, 226, 90, 103)];
    }
    ...
    self.nodiy_boyImgV.image = IMAGE(@"6bboyy");
    ...
    if ([ZMSystemTool iPhone5Device]) {
        ...
        self.nodiy_girlImgV = [[UIImageView alloc] initWithFrame:CGRectMake(173, 245, 65, 75)];
        
    }else if ([ZMSystemTool iPhone6Device]) {
        
        self.nodiy_girlImgV = [[UIImageView alloc] initWithFrame:CGRectMake(200 + 1, 295, 70, 80)];
        
    } else {
        
        self.nodiy_girlImgV = [[UIImageView alloc] initWithFrame:CGRectMake(220, 323, 80, 90)];
    }
    
    self.nodiy_girlImgV.userInteractionEnabled = YES;
    self.nodiy_girlImgV.backgroundColor = [UIColor clearColor];
    self.nodiy_girlImgV.image = IMAGE(@"5bgirll");
...
//眼镜 1
    ...
    if ([ZMSystemTool iPhone5Device]) {
        ...
        self.roleHeadGlassImgV = [[UIImageView alloc] initWithFrame:CGRectMake(80 - 5, 170 - 5, 97, 35)];
        
    }else if ([ZMSystemTool iPhone6Device]) {
        
        self.roleHeadGlassImgV = [[UIImageView alloc] initWithFrame:CGRectMake(95, 230 - 20 - 3, 105, 35)];
        
    } else {
        
        self.roleHeadGlassImgV = [[UIImageView alloc] initWithFrame:CGRectMake(95 + 10, 230, 110, 40)];
    }
...
//眼镜 2
    ...
    if ([ZMSystemTool iPhone5Device]) {
        ...
        self.roleHeadGlassImgV2 = [[UIImageView alloc] initWithFrame:CGRectMake(200 - 33, 317 - 50, 80, 30)];
        
    }else if ([ZMSystemTool iPhone6Device]) {
        
        self.roleHeadGlassImgV2 = [[UIImageView alloc] initWithFrame:CGRectMake(200 - 10, 317 - 3, 90, 30)];
        
    } else {
        
        self.roleHeadGlassImgV2 = [[UIImageView alloc] initWithFrame:CGRectMake(205 + 10, 340, 100, 35)];
    }
...
- (void)setupChoosePhotoOrCamera
{
    ...
    if ([ZMSystemTool iPhone5Device]) {
        ...
        self.photoChosebgV = [[UIView alloc] initWithFrame:CGRectMake(190 - 55, 240 ,  140, 150)];//190 - 55, 240 ,  140, 150
...
#pragma mark ------------------------------------关闭按钮
    ...
    [self.closeeBtn addTarget:self action:@selector(closeeBtniBtnnnClicked) forControlEvents:UIControlEventTouchUpInside];
...
//                
//                self.photoChosebgV.frame = CGRectMake(190 - 55, 240 ,  140, 150);
//                
//                
//            } else {
//                
...
//        
//        
////        self.xxBtn.hidden = NO;
////        self.glassBtn.hidden = NO;
...
//        
    ...
    //if (_chooseGirl == YES) {
        ...
        if (faceStr2 == nil || faceStr2 == NULL || [faceStr2 isKindOfClass:[NSNull class]]) {
            ...
            UIImage *faceImg2 = [UIImage imageWithData:decodeImgData];
            
            
           
            UIImage *testtt = [ZRRImageTool imageTranslateToSuMiao:faceImg2];
...
//////////////////加个滤镜
    ...
    //}else {
        ...
        if (faceStr == nil || faceStr == NULL || [faceStr isKindOfClass:[NSNull class]]) {
            ...
            UIImage *testtimgg = [ZRRImageTool imageTranslateToSuMiao:faceImg];
            
            
            
            UIImage *colorrImg22 = [ZRRImageTool filerWithOriginalImage:testtimgg fileterName:[self.filterNameArray objectAtIndex:40]];
            

            
            
            self.roleHeadImgV.image = colorrImg22;
...
///男生头像
    ...
    if (faceStr == nil || faceStr == NULL || [faceStr isKindOfClass:[NSNull class]]) {
        ...
        self.roleHeadImgV.image = testtimgg;
...
#pragma mark ---------------------------------脸型 cell
        ...
        static  NSString *cellIdentifier = @"facediy";
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    if (tableView == self.xxTableV) {
        ...
        //if (_chooseGirl == YES) {
            ...
            if (indexPath.row == 0) {
                //
                //[self xxTableVSelectedBtnClicked];
                ...
                if (first_second == nil || first_second == NULL || [first_second isKindOfClass:[NSNull class]]) {
                    ...
                    [self.navigationController pushViewController:[ZMDIYCartoonnSecondDIYYViewController sharedZMDIYCartoonnSecondDIYYViewController] animated:NO];
...
#pragma mark ------------------------------------女脸 调整坐标
            if (indexPath.row == 0) {
                ...
                if ([ZMSystemTool iPhone5Device]) {
                    ...
                    self.maskkBgImgVv2.frame = CGRectMake(100 - 34 + 95, 122 + 92,  95, 110);
                    
                    
                    self.roleHeadCoverImgV4.frame = CGRectMake(0, 0, 95, 110);
                    
                }else if ([ZMSystemTool iPhone6Device]) {
                    
                    self.maskkBgImgVv2.frame = CGRectMake(205 - 20, 287 - 29,  105, 121);
                    ...
                    self.maskkBgImgVv2.frame = CGRectMake(205 + 2, 286 + 2,  115, 131);
            ...
            if (indexPath.row == 1) {
                ...
                if ([ZMSystemTool iPhone5Device]) {
                    ...
                    self.maskkBgImgVv2.frame = CGRectMake(100 - 34 + 93, 122 + 92,  95, 110);
                    ...
                    self.maskkBgImgVv2.frame = CGRectMake(205 + 3, 287 ,  115, 131);
            ...
            if (indexPath.row == 2) {
                ...
                if ([ZMSystemTool iPhone5Device]) {
                    ...
                    self.maskkBgImgVv2.frame = CGRectMake(205 + 2, 287 ,  115, 131);
                    
                    
                    self.roleHeadCoverImgV4.frame = CGRectMake(0, 0, 114, 131);
...
#pragma mark --------------------------------男脸 调整坐标
            ...
            if (indexPath.row == 0) {
                ...
                if ([ZMSystemTool iPhone5Device]) {
                    ...
                    self.maskkBgImgVv.frame = CGRectMake(100 - 36, 122,  115, 130);
                    
                    
                    self.roleHeadCoverImgV2.frame = CGRectMake( 0, 0, 115 , 130);
                    
                    //头发
                    self.roleHeadHairImgV.frame = CGRectMake(34 - 12, 72 + 3, 195, 160);
                    
                    
                }else if ([ZMSystemTool iPhone6Device]) {
                    
                    self.maskkBgImgVv.frame = CGRectMake(100 - 10, 187 - 18,  115, 130);
                    ...
                    self.maskkBgImgVv.frame = CGRectMake(100 , 187 ,  120 , 140);
                    
                    
                    self.roleHeadCoverImgV2.frame = CGRectMake( 0, 0, 120 , 140);
                }
            ...
            if (indexPath.row == 1) {
                ...
                if ([ZMSystemTool iPhone5Device]) {
                    ...
                    self.maskkBgImgVv.frame = CGRectMake(100 - 34, 122,  115, 130);
...
- (void)dapeidiyBtnCliickked
{
    ...
    if (first_second == nil || first_second == NULL || [first_second isKindOfClass:[NSNull class]]) {
        ...
        [NSUserDefaults standardUserDefaults].diy_DapeiBtnClicked = @"dapei0";
...
//            [self.navigationController pushViewController:imgLibVC animated:YES];
        ...
        [self dismissViewControllerAnimated:YES completion:^{
            ...
            NSData *imgData = UIImageJPEGRepresentation(boy_img, .2f);
...
//    }
    ...
    if ([ZMSystemTool iPhone5Device]) {
        ...
        self.photoChosebgV.frame = CGRectMake(120 - 65, 200 - 50,  140, 150);
...
#pragma mark -----------------------------顶部栏 关闭按钮
- (void)closeeBtniBtnnnClicked
{
...
- (void)saveeBttnnnClicked
{
    ...
    dispatch_after(dispatch_time(DISPATCH_TIME_NOW, (int64_t)(0.3 * NSEC_PER_SEC)), dispatch_get_main_queue(), ^{
        ...
        [NSUserDefaults standardUserDefaults].diy_firstOrSecond = @"1";//保存标识
...
- (void)xxTableVSelectedBtnClicked//:(UIButton *)btn
{
    ...
    ZMCartoonDIYYModel *model = self.xxMuArray[0];
