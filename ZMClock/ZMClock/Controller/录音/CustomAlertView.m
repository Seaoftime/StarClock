...
-(instancetype)initWithAlertViewHeight:(CGFloat)height
{
    ...
    if (self) {
        ...
        UIImageView *image = [[UIImageView alloc] initWithFrame:CGRectMake(AlertViewJianGe, 0, MAINSCREENwidth-2*AlertViewJianGe, AlertViewHeight)];
        image.image = [UIImage imageNamed:@"提示框标头"];
        ...
        [cancelButton setBackgroundImage:[UIImage imageNamed:@"取消"] forState:0];
        ...
        [qRButton setBackgroundImage:[UIImage imageNamed:@"确定"] forState:0];
