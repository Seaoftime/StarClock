...
#import "ZMGameMoreDesignBaseViewController.h"

@implementation ZMGameMoreDesignBaseViewController
...
-(BaseNavigationView *)baseNavigation
{
    ...
    {
        _baseNavigation = [[BaseNavigationView alloc]initWithFrame:CGRectMake(0, 0, kScreen_Width, 64) withType:3];
