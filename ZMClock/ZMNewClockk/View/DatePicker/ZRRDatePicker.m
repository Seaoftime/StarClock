...
#import "ZRRDatePicker.h"

@implementation ZRRDatePicker
...
- (void)showInView:(UIView *)view withFrame:(CGRect)frame andDatePickerMode:(UIDatePickerMode)mode
{
    ...
    [btnDone setTitleColor:[UIColor colorWithRed:138/255.0 green:207/255.0 blue:138/255.0 alpha:1.0] forState:UIControlStateNormal];
