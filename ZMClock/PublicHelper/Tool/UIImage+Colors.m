...
-(NSMutableArray*)mainColoursInDetail:(int)detail {
    ...
    for (NSString * key in temp){
        ...
        float b = [rgb[2] floatValue];
        UIColor * colour = [UIColor colorWithRed:(r/255.0f) green:(g/255.0f) blue:(b/255.0f) alpha:1.0f];
        colourDictionary[@"color"] = colour;
        colourDictionary[@"percentage"] = [NSNumber numberWithFloat:percentage];
        CGFloat hue;
        CGFloat saturation;
        CGFloat brightness;
        CGFloat alpha;
        BOOL issuccess = [colour getHue:&hue saturation:&saturation brightness:&brightness alpha:&alpha];
        colourDictionary[@"saturation"] = [NSNumber numberWithFloat:saturation];
        [colorArr addObject:colourDictionary];
    }
...
- (NSMutableArray*)rgbColoursInDetail:(int)detail {
    ...
    //set percentages
    NSMutableArray * rgbArr = [NSMutableArray new];
    //NSMutableArray * colorArr = [NSMutableArray new];
    ...
    for (NSString * key in temp){
        ...
        NSString *rgbbb = [NSString stringWithFormat:@"%.f,%.f,%.f",r,g,b];
        
        [rgbArr addObject:rgbbb];
    }
