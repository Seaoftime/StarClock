...
@interface ZMComicSubmitViewController () <SubmitViewDeletage,ImagePickerHelperDeletage>
...
@implementation ZMComicSubmitViewController
...
-(SubmitView*)submitView
{
    if (_submitView == nil)
    {
        ...
        [_submitView resetFrame:CGRectMake(10, 80, kScreen_Width-20, kScreen_Height-70)];
