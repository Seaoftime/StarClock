//
//  ZMChatManagerChangeViewController2.m
//  ZMClock
//
...
@interface ZMChatManagerChangeViewController2 ()<UITextFieldDelegate>
...
@implementation ZMChatManagerChangeViewController2
...
- (void)viewDidLoad {
    ...
    NSString *nickStr = [NSUserDefaults standardUserDefaults].youWantListen_Nickname;
...
- (void)navRightBtnAction:(UIButton*)sender
{
    ...
    [NSUserDefaults standardUserDefaults].youWantListen_Nickname = self.changeTF.text;
